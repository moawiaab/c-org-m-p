<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group  row{{ $errors->has('bank.amount') ? 'invalid' : '' }}">
        <label class="control-label col-sm-2" for="amount">{{ trans('cruds.bank.fields.amount') }}</label>
        <div class="col-sm-8">
            <input class="form-control" type="number" name="amount" id="amount" wire:model.defer="bank.amount"
                step="0.01">
            <div class="validation-message">
