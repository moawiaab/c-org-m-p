<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group row {{ $errors->has('expense.bud_name_id') ? 'invalid' : '' }}">
        ...
        <div class="col-sm-8">
            ...
            <x-select-list class="form-control" id="budget" name="budget" :options="$this->listsForFields['budget']"
                wire:model="expense.bud_name_id" disabled />
            @else
            <x-select-list class="form-control" id="budget" name="budget" :options="$this->listsForFields['budget']"
                wire:model="expense.bud_name_id" />
            @endif
    ...
    <div class="form-group row {{ $errors->has('expense.amount') ? 'invalid' : '' }}">
        ...
        <div class="col-sm-8">
            <input class="form-control" type="number" name="amount" id="amount" wire:model.defer="expense.amount" @if
                ($expense->stage != 'new') disabled @endif step="0.01">
            <div class="validation-message">
