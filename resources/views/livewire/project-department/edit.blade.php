<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group row {{ $errors->has('projectDepartment.details') ? 'invalid' : '' }}">
        <label class="control-label col-sm-2"
            for="details">{{ trans('cruds.projectDepartment.fields.details') }}</label>
        <div class="col-sm-10">
            <textarea class="form-control" name="details" id="details" wire:model.defer="projectDepartment.details"
                rows="4"></textarea>
            <div class="validation-message">
