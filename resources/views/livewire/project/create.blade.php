<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group row {{ $errors->has('project.all_amount') ? 'invalid' : '' }}">
        <label class="control-label col-sm-2 required" for="all_amount">{{ trans('cruds.project.fields.all_amount') }}</label>
        <div class="col-sm-4">
    ...
    <div class="form-group row {{ $errors->has('project.project_branch_id') ? 'invalid' : '' }}">
        <label class="control-label col-sm-2 required" for="project_branch">{{ trans('cruds.project.fields.project_branch')
            }}</label>
        <div class="col-sm-8">
            {{--
            ...
            <select class="form-control" name="project_branch" id="project_branch"
                wire:model="project_branch_id" required>
                <option value=""></option>
