<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('role.br_id') ? 'invalid' : '' }}">
        <label class="form-label" for="br">{{ trans('cruds.role.fields.br') }}</label>
        <x-select-list class="form-control" id="br" name="br" :options="$this->listsForFields['br']" wire:model="role.br_id" />
        <div class="validation-message">
