                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    @can('user_alert_show')
                                        <a class="btn btn-sm  mr-2" href="{{ route('admin.user-alerts.show', $userAlert) }}">
                                            <i class="far fa-eye text-info" title="{{ trans('global.view') }}"></i>
                                        </a>
                                    @endcan
                                    @can('user_alert_edit')
                                        <a class="btn btn-sm mr-2" href="{{ route('admin.user-alerts.edit', $userAlert) }}">
                                            <i class="far fa-edit text-success" title="{{ trans('global.edit') }}"></i>
                                        </a>
                                    @endcan
                                    @can('user_alert_delete')
                                        <button class="btn btn-sm mr-2" type="button" wire:click="confirm('delete', {{ $userAlert->id }})" wire:loading.attr="disabled">
